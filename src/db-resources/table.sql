...
CREATE TABLE akira.AUI_SUMMARY (sid INT UNSIGNED NOT NULL AUTO_INCREMENT, LogDate varchar(12) , URLRequested VARCHAR(255) ,SuccessStatusCode int,FailureStatusCode int, AverageTimeInMicro INT UNSIGNED, KEY fk_id (sid));	 
